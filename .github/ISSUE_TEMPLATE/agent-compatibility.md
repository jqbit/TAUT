...
about: Report whether TAUT works (or doesn't) on a specific AI coding agent
...
- **TAUT version deployed**: e.g. `v0.13`
...
- If proposing TAUT v0.14+ rule additions, list them here.
